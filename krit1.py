...
def calculate():  # เมื่อกดปุ่มคำนวณแล้วให้เรียกใช้ฟังก์ชั่น
    et2.delete(0, END)  # ให้ล้างค่าเมื่อมีการคำนวณเสร็จแล้วไม่ให้กดซ้ำได้
    r = radius.get()  # ใช้ .get() เพื่อรับค่าจากตัวแปร IntVar()
    area = 3.14 * r * r
    et2.insert(0, area)
